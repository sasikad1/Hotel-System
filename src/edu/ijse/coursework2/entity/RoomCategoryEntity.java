...
public class RoomCategoryEntity {
    ...
    public RoomCategoryEntity(Integer room_cate_id, String room_cate_name, String room_cate_description) {
        this.room_cate_id = room_cate_id;
        this.room_cate_name = room_cate_name;
        this.room_cate_description = room_cate_description;
    }

    public RoomCategoryEntity(String room_cate_name, String room_cate_description) {
        this.room_cate_name = room_cate_name;
        this.room_cate_description = room_cate_description;
    }
    ...
    public String toString() {
        return "RoomCategoryEntity{" + "room_cate_id=" + room_cate_id + ", room_cate_name=" + room_cate_name + ", room_cate_description=" + room_cate_description + '}';
    }
